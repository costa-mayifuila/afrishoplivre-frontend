  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow max-w-4xl w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link
          to="/minha-conta/marketing/campanhas"
        ...
        <Link
          to="/minha-conta/marketing/desempenho"
        ...
        <Link
          to="/minha-conta/marketing/promocoes"
          className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg hover:shadow-md transition"
        >
          <div className="flex items-center gap-3 mb-2">
        ...
        <Link
          to="/minha-conta/marketing/links"
          className="p-4 bg-purple-50 border border-purple-200 rounded-lg hover:shadow-md transition"
        >
          <div className="flex items-center gap-3 mb-2">
