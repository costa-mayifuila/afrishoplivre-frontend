...
const PagamentoDeposito = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch('/api/pagamentos/deposito', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-xl mx-auto bg-white p-6 rounded-xl shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-center text-blue-700">💰 Depósito Bancário</h2>

        <p className="text-sm mb-4 text-gray-700">
          Faça o depósito e envie o comprovativo de pagamento:
        </p>

        <div className="bg-blue-100 p-4 rounded text-sm mb-6">
          <p><strong>Banco:</strong> BAI</p>
          <p><strong>Conta:</strong> 000000000002</p>
          <p><strong>Titular:</strong> CMC TECNOLOGIA, SU, LDA</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="number"
            placeholder="Valor depositado (Kz)"
            className="w-full border p-2 rounded"
            value={valor}
...
export default PagamentoDeposito;
