...
const Profile = () => {
  ...
  if (loading)
    return <div className="text-center mt-10 text-gray-600">🔄 Carregando perfil...</div>;

  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-blue-700 mb-6 text-center">👤 Meu Perfil</h1>
